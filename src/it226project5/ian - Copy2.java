    ...
    public void run() throws IOException {
        ...
        while (!userInput.equalsIgnoreCase("E")) {
    		...
    		if (userInput.equalsIgnoreCase("s")) {
    			...
    			String newFileName = menuSelection.nextLine();
    			...
    			for(int n=0;n<gradeBooks.size();n++){
    				...
    				for(int b=1;b<gradeBooks.get(n).size()-1;b++){
                        ...
                        if (id.equals(studentID)){
                        	...
                        	String content = "";
                        	String header="IT"+fileName[0]+"-"+fileName[1].toUpperCase().charAt(0)+"-"+fileName[2];
                            for(int u=0;u<columnTitles.length;u++){
                            	content=content+header+columnTitles[u]+ ",";
                            }
                            bw.write(content);
                            bw.newLine();
                            content="";
                            ...
                            for(int u=0;u<studentInfo.length;u++){
                            	content=content+studentInfo[u]+ ",";
                            }
                            bw.write(content);
                            bw.newLine();
                            
                            System.out.println("Saved to project file location!");
                        }
    				}
